...
class CNNClassifier(nn.Module, Model):
    def __init__(self, input_size, hidden_sizes, num_classes=2, feature_resolution=16):
        ...
        conv_output_size = 128 * (feature_resolution // 8) * (feature_resolution // 8)
        fc_layers = []
